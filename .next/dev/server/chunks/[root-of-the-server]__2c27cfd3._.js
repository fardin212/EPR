...
"[project]/app/api/treasury/accounts/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, ctx) {
    try {
        ...
        const openingBalance = body?.openingBalance === undefined || body?.openingBalance === null ? undefined : safeNum(body.openingBalance);
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].treasuryAccount.findFirst({
            where: {
                id,
                company: {
                    id: companyId
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].treasuryAccount.update({
            where: {
                id
            },
            data: {
...
async function DELETE(_req, ctx) {
    try {
        ...
        const used = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].treasuryTransaction.count({
            where: {
                OR: [
                    {
                        fromAccountId: id
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].treasuryAccount.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c27cfd3._.js.map