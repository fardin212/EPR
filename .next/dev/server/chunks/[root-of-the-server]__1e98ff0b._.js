...
"[project]/app/api/project-types/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const types = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].projectType.findMany({
            orderBy: {
                id: "asc"
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(types);
    } catch (err) {
...
async function POST(req) {
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].projectType.create({
            data: {
                name: body.name.trim(),
                code: body.code.trim(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e98ff0b._.js.map