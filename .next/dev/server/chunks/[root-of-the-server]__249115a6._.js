...
async function GET(req) {
    try {
        ...
        if (simple === "1" || simple === "true") {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(simpleList);
        }
...
async function POST(req) {
    try {
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.create({
            data: {
                companyId: user.companyId,
                sku,
                name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__249115a6._.js.map