...
"[project]/app/api/accounting/period-locks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const locks = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].accountingPeriodLock.findMany({
        where: {
            companyId
        },
        orderBy: [
...
async function POST(req) {
    try {
        ...
        if (periodTo < periodFrom) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("periodTo باید بعد از periodFrom باشد.", {
                status: 400
            });
        }
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].accountingPeriodLock.create({
            data: {
                companyId,
                periodFrom,
                periodTo,
        ...
        console.error(e);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](e?.message || "خطا در ایجاد قفل", {
            status: 500
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bdba133._.js.map